...
export interface Dashboard {
  meta: {
    ...
    market?: {
      ...
      employment?: { byYear: Record<string, Record<string, number>>; byAgeLatest: Record<string, Record<string, number>>; byAgeYear?: Record<string, Record<string, number>>; latest: string }
